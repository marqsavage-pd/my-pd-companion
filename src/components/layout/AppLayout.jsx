...
import { Home, Droplets, HeartPulse, Activity, Pill, TrendingUp, BookOpen, Package, Plane, Sparkles, Menu, X, LogOut } from "lucide-react";
...
const navItems = [
  ...
  { path: "/nova", label: "Nova", icon: Sparkles },
];
